...
function startConversation() {
    fetch('https://chatbot-for-medina-montessori-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-medina-montessori-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyGdOmJW52RsvG1Nc_Ol32f2AUDjE2z_mmSjc1ikGVpPwtUrU2qzuoyfzUHr4KgWuzp_A/exec';
